...
namespace nav2_recoveries
{
  ...
  public:
        ...
        std::shared_ptr<nav2_costmap_2d::CostmapTopicCollisionChecker> collision_checker) override
    {
      ...
      insiderecovery_pub_ = node->template create_publisher<std_msgs::msg::Bool>("is_recover", 10);
      onConfigure();
    }
    ...
    void activate() override
    {
      ...
      insiderecovery_pub_->on_activate();
    ...
    void deactivate() override
    {
      ...
      insiderecovery_pub_->on_deactivate();
  ...
  protected:
    ...
    rclcpp_lifecycle::LifecyclePublisher<std_msgs::msg::Bool>::SharedPtr insiderecovery_pub_;
    ...
    void execute()
    {
      ...
      auto inside_recovery_msg = std::make_unique<std_msgs::msg::Bool>();
      inside_recovery_msg->data = true;
      insiderecovery_pub_->publish(std::move(inside_recovery_msg));
